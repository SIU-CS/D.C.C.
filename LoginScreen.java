...
public class LoginScreen extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            mEmailView.setError("Inncorrect Email");
            focusView = mEmailView;
            cancel = true;
        }
    ...
    private boolean isEmailValid(String email) {
        ...
        return email.equals("ckyser2@gmail.com");
    }

    private boolean isPasswordValid(String password) {
         return password.equals("ryan1234");
    }
    ...
    private void showProgress(final boolean show) {
        ...
        if(loginSuccess) setContentView(R.layout.layout_profile);
